...
public static class DateExtensions 
{
    ...
    public static DateTime? ParsePart(string s, string regex, string format, IFormatProvider provider, 
    ...
    public static DateTime? ParseExactOrDefault(string s, string format, IFormatProvider provider, 
        DateTime? defaultValue)
    {
        try
        {
